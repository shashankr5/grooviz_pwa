 ...
 * "Data-only ON PURPOSE — a notification block would stop Android from waking the background handler in background/killed, so the stop-alert code wouldn't run. title/body are inside data; the app renders the tray notification itself if needed."
 *
