...
// ─────────────────────────────────────────────────────────────────────────────
// LEGACY WRAPPERS — drop-in replacements so existing call sites keep working
// ─────────────────────────────────────────────────────────────────────────────

Future<String?> showAddNotesPopup(BuildContext context) =>
    showAddNotesSheet(context);
...
Future<void> showReassignPopup(
  ...
  required Function(Map<String, dynamic>) onSelect,
    ...
    showReassignSheet(context, staffList, onSelect: onSelect);
