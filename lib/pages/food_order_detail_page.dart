                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            if (((order['totalOrderPrice'] as num?)?.toDouble() ?? 0.0) > 0) ...[
                              const SizedBox(width: 8),
                              Container(
                                ...
                                child: Text(
                                  '₹${((order['totalOrderPrice'] as num).toDouble()).toStringAsFixed(((order['totalOrderPrice'] as num).toDouble()).truncateToDouble() == ((order['totalOrderPrice'] as num).toDouble()) ? 0 : 2)}',
                                  style: const TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.w800,
